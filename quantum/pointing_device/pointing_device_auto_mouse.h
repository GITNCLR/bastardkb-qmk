...
uint16_t      auto_mouse_get_time_elapsed_at(uint16_t now);             // get elapsed time from a caller-provided timer sample
uint16_t      auto_mouse_get_time_elapsed(void);                        // get time elapsed since last active timer start
